...
class Logger {
  ...
  warn = (
    ...
    console.warn(this.format(chalk.bgYellow.black(' WARN ') + (tag ? this.chalkTag(tag) : ''), chalk.yellow(msg)));
  ...
  error = (
    ...
    console.error(this.format(chalk.bgRed(' ERROR ') + (tag ? this.chalkTag(tag) : ''), chalk.red(msg)));
